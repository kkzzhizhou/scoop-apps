...
@REM del/q "%UserProfile%\桌面\酷我音乐.lnk" >NUL 2>NUL
@REM del/q "%AllUsersProfile%\桌面\酷我音乐.lnk" >NUL 2>NUL
@REM rd/s/q "%UserProfile%\「开始」菜单\程序\酷我音乐"2>NUL
@REM rd/s/q "%AllUsersProfile%\「开始」菜单\程序\酷我音乐"2>NUL
)
...
@REM del/q "%Public%\Desktop\酷我音乐.lnk" >NUL 2>NUL
@REM del/q "%UserProfile%\Desktop\酷我音乐.lnk" >NUL 2>NUL
@REM rd/s/q "%AppData%\Microsoft\Windows\Start Menu\Programs\酷我音乐"2>NUL
@REM rd/s/q "%ProgramData%\Microsoft\Windows\Start Menu\Programs\酷我音乐"2>NUL
)
