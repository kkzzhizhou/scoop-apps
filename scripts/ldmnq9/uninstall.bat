...
::清除桌面和开始菜单快捷方式
del/q "%Public%\Desktop\无界趣连.lnk" >NUL 2>NUL
del/q "%Public%\Desktop\雷电模拟器9.lnk" >NUL 2>NUL
del/q "%Public%\Desktop\雷电多开器9.lnk" >NUL 2>NUL
del/q "%UserProfile%\Desktop\雷电模拟器9.lnk" >NUL 2>NUL
del/q "%UserProfile%\Desktop\雷电多开器9.lnk" >NUL 2>NUL
del/q "%AppData%\Microsoft\Windows\Start Menu\雷电模拟器9.lnk" >NUL 2>NUL
del/q "%AppData%\Microsoft\Windows\Start Menu\雷电多开器9.lnk" >NUL 2>NUL
rd/s/q "%AppData%\Microsoft\Windows\Start Menu\Programs\无界趣连"2>NUL
rd/s/q "%ProgramData%\Microsoft\Windows\Start Menu\Programs\无界趣连"2>NUL
rd/s/q "%AppData%\Microsoft\Windows\Start Menu\Programs\雷电模拟器9"2>NUL
rd/s/q "%ProgramData%\Microsoft\Windows\Start Menu\Programs\雷电模拟器9"2>NUL
...
CLS
ECHO.&ECHO 清除完成，确认删除？
ECHO.&ECHO [1]删除软件但保留用户数据
ECHO.&ECHO [2]删除软件并移除用户数据
