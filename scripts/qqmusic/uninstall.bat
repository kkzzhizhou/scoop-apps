...
@REM ::清除桌面和开始菜单快捷方式
@REM ver|findstr "5\.[0-9]\.[0-9][0-9]*" >NUL && (
@REM del/q "%UserProfile%\桌面\QQ音乐.lnk" >NUL 2>NUL
@REM del/q "%AllUsersProfile%\桌面\QQ音乐.lnk" >NUL 2>NUL
@REM rd/s/q "%UserProfile%\「开始」菜单\程序\TencentVideoMPlayer"2>NUL
@REM rd/s/q "%AllUsersProfile%\「开始」菜单\程序\TencentVideoMPlayer"2>NUL
@REM rd/s/q "%UserProfile%\「开始」菜单\程序\腾讯软件\QQ音乐"2>NUL
@REM rd/s/q "%AllUsersProfile%\「开始」菜单\程序\腾讯软件\QQ音乐"2>NUL )
@REM ver|findstr "\<6\.[0-9]\.[0-9][0-9]*\> \<10\.[0-9]\.[0-9][0-9]*\>" >NUL && (
@REM del/q "%Public%\Desktop\QQ音乐.lnk" >NUL 2>NUL
@REM del/q "%UserProfile%\Desktop\QQ音乐.lnk" >NUL 2>NUL
@REM rd/s/q "%AppData%\Microsoft\Windows\Start Menu\Programs\TencentVideoMPlayer"2>NUL
@REM rd/s/q "%ProgramData%\Microsoft\Windows\Start Menu\Programs\TencentVideoMPlayer"2>NUL
@REM rd/s/q "%AppData%\Microsoft\Windows\Start Menu\Programs\腾讯软件\QQ音乐"2>NUL
@REM rd/s/q "%ProgramData%\Microsoft\Windows\Start Menu\Programs\腾讯软件\QQ音乐"2>NUL )
...
ECHO.&ECHO 清除完成，确认删除？
ECHO.&ECHO 1.删除软件保留音乐缓存数据
ECHO.&ECHO 2.删除软件以及音乐缓存数据
...
IF "%ERRORLEVEL%"=="1" ( PUSHD .. & RD /S/Q "%~DP0" >NUL 2>NUL)
