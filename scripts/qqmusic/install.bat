...
@REM ::创建桌面快捷方式
@REM mshta VBScript:Execute("Set a=CreateObject(""WScript.Shell""):Set b=a.CreateShortcut(a.SpecialFolders(""Desktop"") & ""\QQ音乐.lnk""):b.TargetPath=""%~sdp0QQMusic.exe"":b.WorkingDirectory=""%~sdp0"":b.Save:close")
