...
if ($quiet) { & "$PSScriptRoot\spicetify.exe" backup apply enable-devtool --quiet --no-restart }
else { & "$PSScriptRoot\spicetify.exe" backup apply enable-devtool --no-restart }
