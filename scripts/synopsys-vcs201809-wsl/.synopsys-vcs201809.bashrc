...
export SCL_VER=2018.06
export VCS_VER=O-2018.09-SP2
export VERDI_VER=O-2018.09-SP2
export UVM_VER=1.1d
...
# verdi
export VERDI_HOME=$SYNOPSYS/verdi/Verdi_${VERDI_VER}
export NOVAS_HOME=$SYNOPSYS/verdi/Verdi_${VERDI_VER}
